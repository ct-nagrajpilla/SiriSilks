package com.aniapps.utils.mkloader;
...
import com.aniapps.utils.mkloader.callback.InvalidateListener;
import com.aniapps.utils.mkloader.util.LoaderGenerator;
...
public class MKLoader extends View implements InvalidateListener {
  ...
  private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    loaderView.setColor(typedArray.getColor(R.styleable.MKLoader_mk_color,
